import { Component, Input, AfterViewInit, Compiler, COMPILER_OPTIONS, CompilerFactory, OnDestroy, OnChanges, NgModule, NgZone, ViewChild, ViewContainerRef, ViewEncapsulation, Directive  } from '@angular/core';
